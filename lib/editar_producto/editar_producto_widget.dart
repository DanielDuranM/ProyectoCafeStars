...
class EditarProductoWidget extends StatefulWidget {
  ...
  final DocumentReference? documentoreferencia;
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: StreamBuilder<ProductosRecord>(
            stream: ProductosRecord.getDocument(widget.documentoreferencia!),
            builder: (context, snapshot) {
              ...
              final columnProductosRecord = snapshot.data!;
                  ...
                  Column(
                    ...
                    children: [
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              controller: _model.nombreTextController ??=
                                ...
                                text: columnProductosRecord.nombre,
                              ),
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              controller: _model.tipoTextController ??=
                                  TextEditingController(
                                text: columnProductosRecord.tipo,
                              ),
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              controller: _model.precioTextController ??=
                                  TextEditingController(
                                text: columnProductosRecord.precio.toString(),
                              ),
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              controller: _model.descripcionTextController ??=
                                  TextEditingController(
                                text: columnProductosRecord.descripcion,
                              ),
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          ...
                          if (selectedMedia != null &&
                            ...
                            safeSetState(() =>
                                _model.isDataUploading_uploadDataNueva = true);
                            ...
                            try {
                              ...
                              _model.isDataUploading_uploadDataNueva = false;
                            }
                            if (selectedUploadedFiles.length ==
                                selectedMedia.length) {
                              safeSetState(() {
                                _model.uploadedLocalFile_uploadDataNueva =
                      ...
                      ClipRRect(
                        borderRadius: BorderRadius.circular(8.0),
                        child: Image.memory(
                          _model.uploadedLocalFile_uploadDataNueva.bytes ??
                              Uint8List.fromList([]),
                          width: 200.0,
                          height: 200.0,
                          fit: BoxFit.cover,
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          if (_model.isDataUploading_uploadDataNueva == true) {
                            {
                              safeSetState(() =>
                                  _model.isDataUploading_uploadDatsubir = true);
                              var selectedUploadedFiles = <FFUploadedFile>[];
                              var selectedMedia = <SelectedFile>[];
                              var downloadUrls = <String>[];
                              try {
                                selectedUploadedFiles = _model
                                        .uploadedLocalFile_uploadDataNueva
                                        .bytes!
                                        .isNotEmpty
                                    ? [_model.uploadedLocalFile_uploadDataNueva]
                                    : <FFUploadedFile>[];
                                ...
                                _model.isDataUploading_uploadDatsubir = false;
                              }
                              if (selectedUploadedFiles.length ==
                                      selectedMedia.length &&
                                  downloadUrls.length == selectedMedia.length) {
                                safeSetState(() {
                                  _model.uploadedLocalFile_uploadDatsubir =
                                      selectedUploadedFiles.first;
                                  _model.uploadedFileUrl_uploadDatsubir =
                                      downloadUrls.first;
                                });
                              } else {
                                safeSetState(() {});
                            ...
                            await widget.documentoreferencia!
                              ...
                              imagen: _model.uploadedFileUrl_uploadDatsubir,
                              descripcion: columnProductosRecord.descripcion,
                            ...
                            await widget.documentoreferencia!
                              ...
                              precio: double.tryParse(
                                  _model.precioTextController.text),
                              imagen: columnProductosRecord.imagen,
                              descripcion: columnProductosRecord.descripcion,
                              tipo: _model.tipoTextController.text,
                            ));
                          }
