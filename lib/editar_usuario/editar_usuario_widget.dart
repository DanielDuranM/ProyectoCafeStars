...
class _EditarUsuarioWidgetState extends State<EditarUsuarioWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      stream: UsersRecord.getDocument(widget.usuarioref!),
      builder: (context, snapshot) {
        ...
        final editarUsuarioUsersRecord = snapshot.data!;
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  context
                                      .pushNamed(ContactoPageWidget.routeName);
                                },
                                child: Text(
                                  'Contacto',
                                  style: FlutterFlowTheme.of(context)
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  context
                                      .pushNamed(AcercaDePageWidget.routeName);
                                },
                                child: Text(
                                  'Acerca de ',
                                  style: FlutterFlowTheme.of(context)
                              ...
                              Container(
                                ...
                                child: TextFormField(
                                  controller: _model.correoTextController ??=
                                      TextEditingController(
                                    text: editarUsuarioUsersRecord.email,
                                  ),
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Container(
                                width: 200.0,
                                child: TextFormField(
                                  controller: _model.rolTextController ??=
                                      TextEditingController(
                                    text: editarUsuarioUsersRecord.rol,
                                  ),
                                  focusNode: _model.rolFocusNode,
                                  autofocus: false,
                                  enabled: true,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                  ...
                                  cursorColor:
                                      FlutterFlowTheme.of(context).primaryText,
                                  enableInteractiveSelection: true,
                                  validator: _model.rolTextControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ],
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              await widget.usuarioref!
                                ...
                                email: editarUsuarioUsersRecord.email,
                                displayName: _model.nombreTextController.text,
                                rol: _model.rolTextController.text,
                              ));
