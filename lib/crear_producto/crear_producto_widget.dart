...
import 'crear_producto_model.dart';
export 'crear_producto_model.dart';

class CrearProductoWidget extends StatefulWidget {
  const CrearProductoWidget({super.key});

  static String routeName = 'CrearProducto';
  static String routePath = '/crearProducto';

  @override
  State<CrearProductoWidget> createState() => _CrearProductoWidgetState();
}

class _CrearProductoWidgetState extends State<CrearProductoWidget> {
  late CrearProductoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CrearProductoModel());
          ...
          child: Column(
            ...
            children: [
              ...
              FFButtonWidget(
                onPressed: () async {
                  ...
                  if (selectedMedia != null &&
                    ...
                    safeSetState(
                        () => _model.isDataUploading_subirImagen = true);
                    ...
                    try {
                      ...
                      _model.isDataUploading_subirImagen = false;
                    }
                    if (selectedUploadedFiles.length == selectedMedia.length) {
                      safeSetState(() {
                        _model.uploadedLocalFile_subirImagen =
              ...
              ClipRRect(
                borderRadius: BorderRadius.circular(8.0),
                child: Image.memory(
                  _model.uploadedLocalFile_subirImagen.bytes ??
                      Uint8List.fromList([]),
                  width: 200.0,
                  height: 200.0,
                  fit: BoxFit.cover,
              ...
              FFButtonWidget(
                onPressed: () async {
                  {
                    safeSetState(
                        () => _model.isDataUploading_uplofirabase = true);
                    var selectedUploadedFiles = <FFUploadedFile>[];
                    ...
                    try {
                      ...
                      selectedUploadedFiles =
                          _model.uploadedLocalFile_subirImagen.bytes!.isNotEmpty
                              ? [_model.uploadedLocalFile_subirImagen]
                              : <FFUploadedFile>[];
                      ...
                      _model.isDataUploading_uplofirabase = false;
                    }
                    if (selectedUploadedFiles.length == selectedMedia.length &&
                        downloadUrls.length == selectedMedia.length) {
                      safeSetState(() {
                        _model.uploadedLocalFile_uplofirabase =
                            selectedUploadedFiles.first;
                        _model.uploadedFileUrl_uplofirabase =
                            downloadUrls.first;
                      });
                  ...
                  await ProductosRecord.collection
                      ...
                      .set(createProductosRecordData(
                        ...
                        precio:
                            double.tryParse(_model.precioTextController.text),
                        imagen: _model.uploadedFileUrl_uplofirabase,
                        descripcion: _model.descripcionTextController.text,
                        tipo: _model.tipoTextController.text,
                      ));

                  context.pushNamed(AdmintracionProductosPageWidget.routeName);
                },
                text: 'Crear Producto',
                options: FFButtonOptions(
                  height: 40.0,
