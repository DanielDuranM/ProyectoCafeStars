                            ...
                            children: [
                                    ...
                                    onPressed: () async {
                                      await PedidosRecord.collection
                                          ...
                                          .set(createPedidosRecordData(
                                            usuarioUid: currentUserReference,
                                            total: functions.sacarTotal(
                                            ...
                                            productos: listViewProductosRecord
                                                .reference,
                                            cantidad: FFAppState().cantidad,
                                            numeroPedido: random_data
                                                .randomInteger(0, 10),
                                          ));

                                      context.pushNamed(
                                          PedidosEstadoPageWidget.routeName);
                                    },
                                    text: 'Comprar',
                                    options: FFButtonOptions(
                                      height: 32.1,
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Precio:${listViewProductosRecord.precio.toString()}',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          font: GoogleFonts.inter(
