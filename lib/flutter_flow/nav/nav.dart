...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? MenuPageWidget() : HomePageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: AcercaDePageWidget.routeName,
          path: AcercaDePageWidget.routePath,
          builder: (context, params) => AcercaDePageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: CreateCuentaPageWidget.routeName,
          path: CreateCuentaPageWidget.routePath,
          builder: (context, params) => CreateCuentaPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: PedidosAnterioresPageWidget.routeName,
          path: PedidosAnterioresPageWidget.routePath,
          builder: (context, params) => PedidosAnterioresPageWidget(),
        ),
        FFRoute(
          name: PedidosEstadoPageWidget.routeName,
          path: PedidosEstadoPageWidget.routePath,
          builder: (context, params) => PedidosEstadoPageWidget(),
        ),
        FFRoute(
          name: PedidosPendientesWidget.routeName,
          path: PedidosPendientesWidget.routePath,
          builder: (context, params) => PedidosPendientesWidget(),
        ),
        FFRoute(
